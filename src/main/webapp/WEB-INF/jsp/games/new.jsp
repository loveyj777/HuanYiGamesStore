        ...
        <div id="ToType" style="width: 100%;height:380px;border-radius: 10px">
            ...
            <div id="typeList" style="width: 100%;height:380px;">
                ...
                <c:choose >
                    ...
                    <c:otherwise>
                        <a href="/games/new?type=10&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>休闲</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    ...
                    <c:otherwise>
                        <a href="/games/new?type=11&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>竞速</span></a>
                    </c:otherwise>
                </c:choose>
