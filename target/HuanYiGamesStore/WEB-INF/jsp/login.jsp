...
<div id="header">
	<div class=" layui-row ">
		<div class="layui-col-lg  layui-col-lg-offset1">
			<img src="http://119.91.193.63:8080/HuanYiGamesStore/img/logo.png" style="width: 220px;" />
		</div>
	</div>
</div>
...
<div id="section" class=" layui-fluid "
	 style=" height: 900px;background: url(http://119.91.193.63:8080/HuanYiGamesStore/img/a.png) no-repeat ;background-size: cover; background-color: rgb(39,39,39);">
	...
	<div class="loginpanel" style="background-color: white;">
		...
		<form class="layui-form"  style="margin-top: 20px; " id="form_UserLogin" lay-filter="userForm"
	...
	<form class="layui-form"  style="margin-top: 20px;" id="form_PhoneLogin"  lay-filter="phoneForm" novalidate="novalidate">
