...
<head>
  ...
  <link   rel="stylesheet" href="http://119.91.193.63:8080/HuanYiGamesStore/js/header.js"/>
  ...
  <style>
    ...
    .coupon-child{
      float: left;height: 120px;width: 17%;margin-left: 2.35%;margin-top: 20px;background: url("http://119.91.193.63:8080/HuanYiGamesStore/img/coupon.png") no-repeat center ;background-size:contain;
    }
    .layui-col-lg2{
    ...
    function indexopen() {
      layui.use('layer', function(){
        ...
        layer.open({
          ...
          ,content:'<div >' +
                  '<span>5秒后自动关闭</span>' +
                  '<p style="margin-top: 10px">项目仓库：</p>' +
                  '<a href="https://github.com/loveyj777/HuanYiGamesStore" style="display: block;margin-top: 10px">GitHub: https://github.com/loveyj777/HuanYiGamesStore</a>' +
                  '<a href="https://gitee.com/yjloveghy/HuanYiGamesStore" style="display: block;margin-top: 10px" >Gitee: https://gitee.com/yjloveghy/HuanYiGamesStore</a>' +
                  '' +
                  '<p style="display: block;margin-top: 20px;color: pink" >Special Thanks : GuoHuanYi❤</p>' +
                  '</div>'
          ,time:5000
          ,btn:'确定'
          ,btn1:function (index){
  ...
  <div  id="main-panel">
      ...
      <div id="roll" style="width: 78%;height: 400px;float: left;box-sizing: border-box;"class="layui-carousel">
        <div carousel-item id="carousel-item">
          <c:forEach items="${rollImg}" var="i">
           <a href="/gameDetails/${i.gid}" style="background: url(http://119.91.193.63:8080/HuanYiGamesStore/img/rollImg/${i.imgFile}) no-repeat center top;background-size: cover" ></a>
          </c:forEach>
        </div>
          ...
          <c:when test="${sessionScope.user == null}">
              <div style="width: 100%">
                <div class="show-person-on-index" style="text-align: center" >
                  <img   src="http://119.91.193.63:8080/HuanYiGamesStore/img/userHeadImg/default.png" class="person-icon-nologin" style="height: 80px;width: 80px;"></img></div>
          ...
          <c:when test="${ sessionScope.user.userName != null}">
            <div style="width: 100%;box-sizing: border-box;overflow:hidden;" class="layui-row ">
              <div class="show-person-on-index  "style="position:relative;">
                <img   src="http://119.91.193.63:8080/HuanYiGamesStore/img/userHeadImg/${sessionScope.user.headImg}" class="person-icon" style="height:80px;width: 80px;display: inline-block"></img>
              ...
              <div  style="box-sizing: border-box;overflow:hidden;width: 100%">
                <a href="/user/games" class="user_menu" target="_blank"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/game.png"/><p>我的游戏</p></a>
                <a href="/user/order" class="user_menu" target="_blank"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/order.png"/><p>我的订单</p></a>
                <a href="/user/coupon" class="user_menu" target="_blank"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/coupon.png"/><p>我的优惠卷</p></a>
                <a href="/user/points" class="user_menu" target="_blank"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/points.png"/><p>我的积分</p></a>
                <a href="/user/setting" class="user_menu" target="_blank"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/userInfo.png"/><p>账号管理</p></a>
                <a href="/index/quit" class="user_menu"><img src="http://119.91.193.63:8080/HuanYiGamesStore/img/user_menuImg/quit.png"  /><p>退出登录</p></a>
              </div>
    ...
    <div id="main-panel-l3"  style="height:550px;min-height: 500px;box-sizing: border-box;overflow: hidden;">
      ...
      <c:forEach items="${discountGame}" var="w" begin="0" end="1">
        <div class="todayWrothBuy-list-big" style="position: relative">
          <img style="position: absolute;width: 100%;height: 250px;left: 0;z-index: 1 ;opacity: 0.4;" src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${w.gamesImg.imgUrl}" >
    ...
    <c:forEach items="${discountGame}" var="w" begin="2" end="3">
          <a class="todayWrothBuy-list-sm" style="position: relative" href="/gameDetails/${w.id}">
            <img  style=" width: 98%;height: 80px;border-radius: 10px;" src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${w.gamesImg.imgUrl}">
      ...
      <c:forEach items="${newGames}" var="i" begin="0" end="6">
          ...
          <a class="personLikePlay-list-sm" style="position: relative"  href="/gameDetails/${i.id}" >
            <img  style="width: 100%;height: 80px;border-radius: 10px; "src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${i.gamesImg.imgUrl}">
            <div class="gameName-down"  >
              <div class="gameName-down-data" >
      ...
      <div id="salesRank" style="height: 500px;width: 30%;float: right;box-sizing: border-box;overflow: hidden;">
        ...
        <div id="salesRank-list" >
          ...
          <a class="rank-child" href="/gameDetails/${i.id}" >
            ...
            <img class="rank-child-img" src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${i.orderDetail.productImg}" >
    ...
    <div id="main-panel-l5-indexGame" style="height: 980px; box-sizing: border-box;overflow: hidden">
      <div id="indexGame-tab" style="height: 60px;line-height: 60px;">
        ...
        <div class="layui-row" style="height: 60px;box-sizing: border-box;overflow: hidden;">
          <div class="layui-col-lg2" ><a style="position: relative;cursor: pointer" id="hotSale" >热销</a></div>
          <div class="layui-col-lg2" ><a style="position: relative;cursor: pointer"  id="newGames"  >新品</a></div>
          <div class="layui-col-lg2" ><a  style="position: relative;cursor: pointer" id="discount"  >折扣</a></div>
        </div>
          ...
          <div class="indexGame-info" >
            ...
            <div style="width: 100%; height: 600px;overflow: scroll;" class="indexGame-info-imgs">
              <c:forEach  items="${i.gamesImgs}" var="z">
                <img  src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${z.imgUrl}"  style="  height: 250px;width: 93%;margin: 5px 20px;display: block;border-radius: 10px;" >
              </c:forEach>
            </div>
          </div>
