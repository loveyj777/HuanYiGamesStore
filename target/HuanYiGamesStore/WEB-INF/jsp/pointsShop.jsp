...
<div style="width: 100%;">
    ...
    <div style=" width: 60%;margin: 0 auto;height: 100%">
        ...
        <div id="title" style="width: 100%;font-size: 22px;margin-top: 20px;">积分商城</div>
                ...
                <c:forEach items="${coupons}" var="i" >
                    <div class="coupon-child" >
                        <div class="coupon-text" >
                            ...
                            <p style="color: gray;overflow: hidden;text-overflow: ellipsis;text-space: nowrap;margin-left: 5px">${i.condition}</p>
                        </div>
