        ...
        $(function () {
            ...
            $('#PriceSlider').mousedown(function () {
                $('#PriceSlider').mousemove(function () {
                    ...
                    location.href='/games/priceUp?price='+$('#PriceSlider').text()+'&type=${type}&pageNum=1&pageSize=13'
        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    //首次不执行
                    if(!first){
                        location.href='/games/priceUp?price=${price}<c:if test="${type != null}">&type=${type}</c:if>'+'&pageNum='+obj.curr+'&pageSize='+obj.limit
                    }
                }
...
<div class="layui-fluid" style=" height: 1400px;">
    ...
    <div id="gameList-panel" style="float: left;width: 45%;margin-left: 20%;margin-top: 50px;box-sizing: border-box;overflow: hidden">
        ...
        <div id="ListHead" style="height: 50px;background-color: white;border-radius: 10px;">
            ...
            <a href="/games/priceDown?pageNum=1&pageSize=13" id="pricesort" class="sort-price">价格<i class=" layui-icon layui-icon-up up" style="color: orangered;position:  relative; top: -5px;font-size: 15px;left: 5px;"></i><i class="layui-icon layui-icon-down down" style="position:  relative; top:8px;left: -10px;font-size: 15px;"></i></a>
        </div>



        <div id="Game-list-HotSale" style="width:100%;margin-top:10px;position: relative;">

            <c:if test="${total eq 0}">
                <div style="width: 100%;height:100px;text-align: center;line-height: 100px">暂无相关数据</div>
            </c:if>

            <c:forEach items="${priceup}" var="i" >
            ...
            <div id="typeList" style="width: 100%;height:380px;">
                <c:choose >
                    <c:when  test="${type eq 1}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>动作</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>动作</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=1&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>动作</span></a>
                    </c:otherwise>
                </c:choose>

                <c:choose >
                    <c:when  test="${type eq 2}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>冒险</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>冒险</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=2&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>冒险</span></a>
                    </c:otherwise>
                </c:choose>

                <c:choose >
                    <c:when  test="${type eq 3}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>角色扮演</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>角色扮演</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=3&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>角色扮演</span></a>
                    </c:otherwise>
                </c:choose>

                <c:choose >
                    <c:when  test="${type eq 4}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>射击</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>射击</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=4&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>射击</span></a>
                    </c:otherwise>
                </c:choose>

                <c:choose >
                    <c:when  test="${type eq 5}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>大型多人在线</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>大型多人在线</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=5&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>大型多人在线</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    <c:when  test="${type eq 6}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>策略</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>策略</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=6&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>策略</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    <c:when  test="${type eq 7}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>模拟</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>模拟</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=7&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>模拟</span></a>
                    </c:otherwise>
                </c:choose>

                <c:choose >
                    <c:when  test="${type eq 8}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>体育</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>体育</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=8&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>体育</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    <c:when  test="${type eq 9}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>独立</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>独立</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=9&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>独立</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    <c:when  test="${type eq 10}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>休闲</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>休闲</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=10&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>休闲</span></a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose >
                    <c:when  test="${type eq 11}">
                        <c:if test="${price != null}"><a href="/games/priceUp?price=${price * 25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-radio "></i><span>竞速</span></a></c:if>
                        <c:if test="${price eq null}"><a href="/games/priceUp?pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>竞速</span></a></c:if>
                    </c:when>
                    <c:otherwise>
                        <a href="/games/priceUp?type=11&price=${price *25}&pageNum=1&pageSize=13" ><i class="layui-icon layui-icon-circle "></i><span>竞速</span></a>
                    </c:otherwise>
                </c:choose>
