        ...
        $(function () {
            ...
            $('#PriceSlider').mousedown(function () {
                $('#PriceSlider').mousemove(function () {
                    ...
                    location.href='/games/priceDown?price='+$('#PriceSlider').text()+'&type=${type}&pageNum=1&pageSize=13'
        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    //首次不执行
                    if(!first){
                        location.href='/games/priceDown?price=${price}<c:if test="${type != null}">&type=${type}</c:if>'+'&pageNum='+obj.curr+'&pageSize='+obj.limit
                    }
                }
...
<div class="layui-fluid" style=" height: 1400px;">
    ...
    <div id="gameList-panel" style="float: left;width: 45%;margin-left: 20%;margin-top: 50px;box-sizing: border-box;overflow: hidden">
        ...
        <div id="ListHead" style="height: 50px;background-color: white;border-radius: 10px">
            ...
            <a href="/games/priceUp?pageNum=1&pageSize=13" id="pricesort" class="sort-price">价格<i class=" layui-icon layui-icon-up up" style="position:  relative; top: -5px;font-size: 15px;left: 5px;"></i><i class="layui-icon layui-icon-down down" style="color: orangered;position:  relative; top:8px;left: -10px;font-size: 15px;"></i></a>
        </div>
        ...
        <div id="Game-list-HotSale" style="width:100%;margin-top:10px;position: relative;">
            ...
            <c:forEach items="${pricedown}" var="i" >
