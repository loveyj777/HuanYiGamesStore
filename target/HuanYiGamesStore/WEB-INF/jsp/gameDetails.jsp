...
<head>
    ...
    <style>
        ...
        #addShopcar{
            border: 1px solid orangered; color: orangered;width: 45%;height: 50px;line-height: 50px;text-align: center;display: inline-block;overflow: hidden;border-radius: 8px;font-size: 20px; cursor: pointer;
        }
        ...
        .sortup{
      background: url(http://119.91.193.63:8080/HuanYiGamesStore/img/sort-up.png);position: absolute;z-index: 100;top: -20px;left: 50px;display: inline-block;width: 32px;height: 19px;display: none;
        }
        .border-color{
    ...
    <div id="details" style="width: 65%;margin: 0 auto;height: 1200px;">
        ...
        <div id="game-introduction-img" >
            ...
            <div class="img-sm-div">
                ...
                <div class="img-sm-border"  >
                    <i  class="sortup"></i>
                    <img style="width: 100%;height: 86px;border-radius: 10px;" src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${i.gamesImg.imgUrl}" class="img-sm"/>
                </div>
                </c:forEach>
            </div>
        </div>
        ...
        <div id="game-introduction-buy" style="background: white ;">
            ...
            <div style="height: 110px;border-radius: 10px;margin: 15px;background-color: rgb(235,235,235)">
                <img id="intro-img"  src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${game.gamesImg.imgUrl}" />
