...
<head>
    ...
    <style>
        ...
        .coupon-child{
           height: 120px;width:180px;margin-left: 2.35%;background: url("http://119.91.193.63:8080/HuanYiGamesStore/img/coupon.png") no-repeat center ;background-size:contain;border: 2px dashed grey;float:left;
    ...
    <div id="shopCar" style="width: 60%;margin: 0 auto;margin-top: 30px;">
        ...
        <div style="clear: both;height: 100px;box-sizing: border-box;line-height: 40px">
            ...
            <div style="text-align: right;overflow: hidden;">
                <div style="height: 40px;line-height: 40px;text-align: center;width: 200px;float: right;border-radius: 8px;background:linear-gradient(rgb(250,86,0) ,rgb(255,158,0) );cursor:pointer;" id="pay">支付订单</div>
            </div>
        </div>
    </div>
