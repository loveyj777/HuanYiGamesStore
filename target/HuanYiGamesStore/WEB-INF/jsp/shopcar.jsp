        ...
        <div id="shopcar-main" style="margin-top: 30px;">
          ...
          <c:forEach items="${shopCarList}" var="i">
              <a  class="Game-child " style="width: 100%;">
                  ...
                  <img class="list-img" src="http://119.91.193.63:8080/HuanYiGamesStore/img/gamesImg/${i.games.gamesImg.imgUrl}">
                  ...
                  <div class="list-ToolBox">
                      <p style="font-size: 16px;cursor: pointer" class="delete">删除</p>
                  </div>
              </a>
          </c:forEach>
